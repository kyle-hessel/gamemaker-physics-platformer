...
//only use the gun if alive and in our inventory
if (oPlayer.healthState != healthStates.DEAD) {

	if (inInventory == true && oPlayer.activeSlot == oPlayer.playerInventory[1]) {
	...
	} else if (inInventory == true && oPlayer.activeSlot != oPlayer.playerInventory[1]) {
